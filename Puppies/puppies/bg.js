...
(function() {
    ...
    var self = {
        ...
        updateContextMenu: function (items) {
            ...
            chrome.contextMenus.remove("puppiesInactivate");
            chrome.contextMenus.remove("puppiesInactivate");

            if (items.contextmenu && items.activate) {
                chrome.contextMenus.create({
                    "id": "puppiesInactivate",
        ...
        openOptions:function(){
            var optionsUrl = chrome.extension.getURL('puppies/options/options.html');
